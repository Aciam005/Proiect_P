...
def OpenFile():
    ...
    #If there is a valid file opened,parse it into a string
    #Else return null
    if file_path:
...
btn_file = tk.Button(input_frame, text="Select File", font=('Helvetica', 14, 'bold'), bg="#4682B4", fg="white", activebackground="#5A9", activeforeground="white", command=OpenFile)
